...
function scrollFloorView(){
	...
	if(500 < ling && ling < 500+165) { //第一层的数字隐藏，文字显示，其他兄弟元素的li数字显示，文字隐藏
	...
	} else if(500+165 <ling && ling < 500+165+411) {
	...
	} else if(500+165+411<ling && ling < 500+165+411+360) {
	...
	if(ling > 500+165+411+360 || ling < 500) {
		$("#floor-index").hide();
	}
}
$(function() {
